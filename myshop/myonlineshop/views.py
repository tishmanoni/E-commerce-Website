...
def product_detail(request, id, slug):
    ...
    return render(request,'shop/product/detail.html', {'product': product, 'cart_product_form': cart_product_form, 'recommended_products': recommended_products , 'categories':categories, "comments":comments, 'cart_size_form':cart_size_form})  
